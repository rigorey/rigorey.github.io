# 3-column-template
Basic HTML/CSS template with header, right menu, middle and left content columns, and a footer.

## Site Demo
[http://github.tracigardner.com/3-column-rightmenu-template](http://github.tracigardner.com/3-column-rightmenu-template)
...
* Edit the files in the navigation folder to change the content of the site header, the right menu, and the footer. The content in these places is the same throughout the site.
